...
type TransactionRepository interface {
	...
	GetAgentCommissionRule(ctx context.Context, agentID string) (*AgentCommissionRule, error)
	UpsertAgentCommissionRule(ctx context.Context, rule *AgentCommissionRule) error
	GetAgentReconciliation(ctx context.Context, agentID string, from, to time.Time) (*AgentReconciliationReport, error)
